...
async function message(sock, m, store) {
    ...
    const text = `
gunakan *${Prefix}listgrup* untuk masuk ke grup Official Brainxiex
...
Nama: *Lisensi penyihir*
Jumlah: *1*
Harga: *10,000bx*
CMD: *${Prefix}buy lic penyihir*
...
Nama: *Lisensi programmer*
Jumlah: *1*
Harga: *50,000bx*
CMD: *${Prefix}buy lic programmer*
