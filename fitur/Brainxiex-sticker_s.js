...
async function message(sock, m, store) {
    ...
    await sock.editMessage(pem, "Mengirim ke *http://xiex.my.id/api/image/sticker* ...");
    const {data} = await axios.post(`http://xiex.my.id/api/image/sticker`,{apikey, base64: `${buffer}`,pack: isset(arg) ? arg : m.pushName},{ responseType: 'arraybuffer' });
