...
async function message(sock, m, store) {
    ...
    if(true) return nyarios(`fitur ini nonaktif`)
    ...
    sock.add(id,mentioned[0]).then(console.log).catch(console.error);
    nyarios(`@${mentioned[0][`split`]("@")[0]} telah di add oleh @${nomor} dari *${subject}*`)
