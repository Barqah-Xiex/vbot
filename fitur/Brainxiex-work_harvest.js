...
async function message(sock, m, store) {
    ...
    const jenis = Object.keys(await global.rpgitem.Buah()).slice(0,level+1);
    ...
    if(pekerjaan !== `harvester`) return nyarios(`anda bukan harvester`);
    ...
    nyarios(`anda mendaptkan *${dapatnya}bx*`)
